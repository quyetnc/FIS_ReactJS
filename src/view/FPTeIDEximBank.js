...
class FPTeIDEximbank extends Component {
                  ...
                  <Col xs={6} sm={6} md={6} lg={6} xl={6}>
                    <Row style={{}}>
                      <Col xs={12} sm={12} md={12} lg={12} xl={12}>
                        <a href="itms-services://?action=download-manifest&url=https://api.fis.vn:9999/mobilebuild/uploads/poc_eximbank/1.2/POC_EXIMBANK.plist"
                    ...
                    <Row>
                      <Col xs={12} sm={12} md={12} lg={12} xl={12}>
                        <a href="https://api.fis.vn:9999/mobilebuild/uploads/poc_eximbank/1.2/poc_eximbank_v1.2.apk"
                        >
                          <Button variant='outline-secondary'
                            style={{
                              fontWeight: 'bold',
