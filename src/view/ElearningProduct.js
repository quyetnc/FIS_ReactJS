...
class ElearningProduct extends Component {
              ...
              <Row>
                <Row style={{ marginTop: '50px', marginBottom: '50px' }}>
                  <Col xs={6} sm={6} md={3} lg={4} xl={4}>
                    <Image style={{ width: '100%' }} src={require('../assets/image/eLeaning_white_ios.png')} rounded />
                  </Col>
                  <Col>
              ...
              <Row>
                <Row>
                  <Col xs={6} sm={6} md={5} lg={5} xl={5}>
                    <Image style={{ maxWidth: '100%', height: 'auto' }} src={require('../assets/image/eLearning_home.JPEG')} thumbnail />
                  </Col>
                  <Col xs={6} sm={6} md={6} lg={6} xl={6}>
                    <Row style={{}}>
                      <Col xs={12} sm={12} md={12} lg={12} xl={12}>
                        <a href="itms-services://?action=download-manifest&url=https://api.fis.vn:9999/mobilebuild/uploads/elearning_/1.1.33.7719/eLearning_v1.1.33.7719.plist"
                    ...
                    <Row>
                      <Col xs={12} sm={12} md={12} lg={12} xl={12}>
                        <a href="https://api.fis.vn:9999/mobilebuild/uploads/elearning_/1.1.33.7719/elearning__v1.1.33.7719.apk"
                        >
                          <Button variant='outline-secondary'
                            style={{
                              fontWeight: 'bold',
